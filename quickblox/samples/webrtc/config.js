;(function(window) {
  ...
  var QBAppProd = {
    ...
    /*
     [QBSettings setApplicationID:43284];
     [QBSettings setAuthKey:@"vM2DX7tkJm6x6Cg"];
     [QBSettings setAuthSecret:@"4Zer7DAFGkPF6ZR"];
    * */

    appId: 43284,
    authKey: 'vM2DX7tkJm6x6Cg',
    authSecret: '4Zer7DAFGkPF6ZR'
  ...
  QBUsersProd = [
    ...
    },
    {
      ...
      */
      ...
      /*
       QBUUser *testUser1 = [self userWithID:@(14563261)
       login:@"test1"
       fullName:@"test1"
       passowrd:@"Somkid058848391"];

       QBUUser *testUser2 = [self userWithID:@(14521126)
       login:@"test2"
       fullName:@"test2"
       passowrd:@"Somkid058848391"];
       */
